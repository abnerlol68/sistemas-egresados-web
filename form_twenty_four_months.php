    ...
    <form action="Controller/forms.php" method="POST">
      <div class="content_form">
        ...
        <div class="qt" id="qt_1_11_container">
          ...
          <div class="res">
            <input class="input_text" type="text" name="Modalidad de titulación" id="qt_1_11_r">
          </div>
        </div>
        ...
        <div class="qt" id="qt_1_13_container">
          ...
          <div class="res">
            <select name="Dominio del idioma extranjero (Inglés)" id="qt_1_13_r">
              <option>0%</option>
              <option>20%</option>
              <option>40%</option>
              <option>60%</option>
        ...
        <div class="qt" id="qt_2_2_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_checkbox" type="checkbox" name="Que estudias[]" id="qt_2_2_r_3" value="Maestría">
        ...
        <div class="qt" id="qt_2_3_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="Tiempo transcurrido para obtener tu primer empleo" id="qt_2_3_r_3" value="Entre 6 meses y 1 año">
        ...
        <div class="qt" id="qt_2_4_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="Medio para obtener empleo" id="qt_2_4_r_4" value="Creé mi propia empresa">
        ...
        <div class="qt" id="qt_2_5_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="Antigüedad en el empleo" id="qt_2_5_r_2" value="1 año a 2 años">
              <label for="qt_2_5_r_2">1 año a 2 años</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Antigüedad en el empleo" id="qt_2_5_r_3" value="Más de dos años">
        ...
        <div class="qt" id="qt_2_6_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name=">Cual es la condición de tu empleo" id="qt_2_6_r_2" value="Eventual">
              <label for="qt_2_6_r_2">Eventual</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name=">Cual es la condición de tu empleo" id="qt_2_6_r_3" value="Contrato">
              <label for="qt_2_6_r_3">Contrato</label>
            </div>

            <div>
              <input class="input_radio" type="radio" name=">Cual es la condición de tu empleo" id="qt_2_6_r_4" value="Otros">
        ...
        <div class="qt" id="qt_2_8_container">
          ...
          <div class="res">
            <input class="input_text" type="text" name="Dirección de la empresa (Estado y municipio)" id="qt_2_8_r">
          </div>
        </div>
        ...
        <div class="qt" id="qt_2_10_container">
          ...
          <div class="res">
            <input class="input_tel" type="tel" name="Teléfono (Si tiene extensión anéxala)" id="qt_2_10_r">
          </div>
        </div>
        ...
        <div class="qt" id="qt_2_11_container">
          ...
          <div class="res">
            <input class="input_email" type="email" name="Correo electrónico del mismo" id="qt_2_11_r">
          </div>
        </div>
        ...
        <div class="qt" id="qt_2_13">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="Tamaño de la empresa" id="qt_2_13_r_2" value="Pequeña (31-100)">
              <label for="qt_2_13_r_2">Pequeña (31-100)</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Tamaño de la empresa" id="qt_2_13_r_3" value="Mediana (101-500)">
              <label for="qt_2_13_r_3">Mediana (101-500)</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Tamaño de la empresa" id="qt_2_13_r_4" value="Grande (Más de 500)">
        ...
        <div class="qt" id="qt_2_14_container">
          ...
          <div class="res">
            <input class="input_text" type="text" name="Área o departamento en el que laboras" id="qt_2_14_r">
          </div>
        </div>
        ...
        <div class="qt" id="qt_2_15_container">
          ...
          <div class="res">
            <input class="input_text" type="text" name="Cargo o función que realizas" id="qt_2_15_r">
          </div>
        </div>
        ...
        <div class="qt" id="qt_2_16_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="El área donde laboras es de acuerdo a tu perfil" id="qt_2_16_r_2" value="No">
              <label for="qt_2_16_r_2">No</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="El área donde laboras es de acuerdo a tu perfil" id="qt_2_16_r_3" value="Parcialmente">
        ...
        <div class="qt" id="qt_2_17_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="Sector económico al que pertenece tu empleo actual" id="qt_2_17_r_2" value="Secundario (Industrial, construcción, petróleo)">
              <label for="qt_2_17_r_2">Secundario (Industrial, construcción, petróleo)</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Sector económico al que pertenece tu empleo actual" id="qt_2_17_r_3" value="Terciario (Educativo y servicios profesionales, turismo, telecomunicaciones, servicios financieros y bancos, administración pública y defensa)">
        ...
        <div class="qt" id="qt_2_18_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="Régimen al que pertenece tu empleo actual" id="qt_2_18_r_2" value="Privado">
        ...
        <div class="qt" id="qt_2_19_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="Idioma extranjero que utilizas en tu trabajo" id="qt_2_19_r_2" value="Inglés">
              <label for="qt_2_19_r_2">Inglés</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Idioma extranjero que utilizas en tu trabajo" id="qt_2_19_r_3" value="Francés">
              <label for="qt_2_19_r_3">Francés</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Idioma extranjero que utilizas en tu trabajo" id="qt_2_19_r_4" value="Alemán">
        ...
        <div class="qt" id="qt_2_20_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_checkbox" type="checkbox" name="Principales limitaciones profesionales técnicas que enfrentas en tu empleo actual[]" id="qt_2_20_r_2" value="Resolución de problemas">
              <label for="qt_2_20_r_2">Resolución de problemas</label>
            </div>
  
            <div>
              <input class="input_checkbox" type="checkbox" name="Principales limitaciones profesionales técnicas que enfrentas en tu empleo actual[]" id="qt_2_20_r_3" value="Falta de lenguaje técnico">
              <label for="qt_2_20_r_3">Falta de lenguaje técnico</label>
            </div>
  
            <div>
              <input class="input_checkbox" type="checkbox" name="Principales limitaciones profesionales técnicas que enfrentas en tu empleo actual[]" id="qt_2_20_r_4" value="Aplicación de conocimientos técnicos">
        ...
        <div class="qt" id="qt_3_1_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="La eficiencia para realizar las actividades laborales en relación con tu formación ha sido" id="qt_3_1_r_2" value="Eficiente">
              <label for="qt_3_1_r_2">Eficiente</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="La eficiencia para realizar las actividades laborales en relación con tu formación ha sido" id="qt_3_1_r_3" value="Poco eficiente">
              <label for="qt_3_1_r_3">Poco eficiente</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="La eficiencia para realizar las actividades laborales en relación con tu formación ha sido" id="qt_3_1_r_4" value="Deficiente">
        ...
        <div class="qt" id="qt_3_2_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="Cómo ha sido la relación del trabajo con tu área de formación" id="qt_3_2_r_2" value="20">
              <label for="qt_3_2_r_2">20%</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Cómo ha sido la relación del trabajo con tu área de formación" id="qt_3_2_r_3" value="40">
              <label for="qt_3_2_r_3">40%</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Cómo ha sido la relación del trabajo con tu área de formación" id="qt_3_2_r_4" value="60">
              <label for="qt_3_2_r_4">60%</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Cómo ha sido la relación del trabajo con tu área de formación" id="qt_3_2_r_5" value="80">
              <label for="qt_3_2_r_5">80%</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Cómo ha sido la relación del trabajo con tu área de formación" id="qt_3_2_r_6" value="100">
        ...
        <div class="qt" id="qt_3_5_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="Opotunidad de participar en proyectos de investigación y desarrollo" id="qt_3_5_r_2" value="Eficiente">
              <label for="qt_3_5_r_2">Eficiente</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Opotunidad de participar en proyectos de investigación y desarrollo" id="qt_3_5_r_3" value="Poco eficiente">
              <label for="qt_3_5_r_3">Poco eficiente</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Opotunidad de participar en proyectos de investigación y desarrollo" id="qt_3_5_r_4" value="Deficiente">
        ...
        <div class="qt" id="qt_3_6_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="Énfasis en la investigación dentro del proceso de aprendizaje" id="qt_3_6_r_2" value="Eficiente">
              <label for="qt_3_6_r_2">Eficiente</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Énfasis en la investigación dentro del proceso de aprendizaje" id="qt_3_6_r_3" value="Poco eficiente">
              <label for="qt_3_6_r_3">Poco eficiente</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Énfasis en la investigación dentro del proceso de aprendizaje" id="qt_3_6_r_4" value="Deficiente">
        ...
        <div class="qt" id="qt_4_1_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="Cómo calificas tu formación académica con respecto a tu desempeño laboral" id="qt_4_1_r_2" value="Eficiente">
              <label for="qt_4_1_r_2">Eficiente</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Cómo calificas tu formación académica con respecto a tu desempeño laboral" id="qt_4_1_r_3" value="Poco eficiente">
              <label for="qt_4_1_r_3">Poco eficiente</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Cómo calificas tu formación académica con respecto a tu desempeño laboral" id="qt_4_1_r_4" value="Deficiente">
        ...
        <div class="qt" id="qt_4_2_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="La experiencia obtenida a través de la Residencia Profesional ha sido" id="qt_4_2_r_2" value="Eficiente">
              <label for="qt_4_2_r_2">Eficiente</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="La experiencia obtenida a través de la Residencia Profesional ha sido" id="qt_4_2_r_3" value="Poco eficiente">
              <label for="qt_4_2_r_3">Poco eficiente</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="La experiencia obtenida a través de la Residencia Profesional ha sido" id="qt_4_2_r_4" value="Deficiente">
        ...
        <div class="qt" id="qt_4_3_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="Cuál ha sido la utilidad de la Residencia Profesional para tu desarrollo laboral y profesional" id="qt_4_3_r_2" value="Eficiente">
              <label for="qt_4_3_r_2">Eficiente</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Cuál ha sido la utilidad de la Residencia Profesional para tu desarrollo laboral y profesional" id="qt_4_3_r_3" value="Poco eficiente">
              <label for="qt_4_3_r_3">Poco eficiente</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="Cuál ha sido la utilidad de la Residencia Profesional para tu desarrollo laboral y profesional" id="qt_4_3_r_4" value="Deficiente">
        ...
        <div class="qt" id="qt_4_4_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="La satisfacción académica que te brindó el programa educativo ha sido" id="qt_4_4_r_2" value="Eficiente">
              <label for="qt_4_4_r_2">Eficiente</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="La satisfacción académica que te brindó el programa educativo ha sido" id="qt_4_4_r_3" value="Poco eficiente">
              <label for="qt_4_4_r_3">Poco eficiente</label>
            </div>
  
            <div>
              <input class="input_radio" type="radio" name="La satisfacción académica que te brindó el programa educativo ha sido" id="qt_4_4_r_4" value="Deficiente">
        ...
        <div class="qt" id="qt_5_1_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="Te gustaria tomar algún curso de actualización" id="qt_5_1_r_2" value="No">
        ...
        <div class="qt" id="qt_5_2_container">
          ...
          <div class="res">
            <input class="input_text" type="text" name="Si tu respuesta es afirmativa, qué curso te gustaría tomar" id="qt_5_2_r">
          </div>
        </div>
        ...
        <div class="qt" id="qt_5_3_container">
          ...
          <div class="res">
            ...
            <div>
              <input class="input_radio" type="radio" name="Perteneces a alguna Asociación Civil, Cámaras Industriales o Colegios Profesionales" id="qt_5_3_r_2" value="No">
        ...
        <div class="qt" id="qt_5_4_container">
          ...
          <div class="res">
            <input class="input_text" type="text" name="Cuál" id="qt_5_4_r">
          </div>
        </div>
        ...
        <div class="qt" id="qt_5_5_container">
          ...
          <div class="res">
            <input class="input_text" type="text" name="Comentarios o sugerencias (Para mejorar la formación profesional de los egresados de tu carrera)" id="qt_5_5_r">
          </div>
        </div>
