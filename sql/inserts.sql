...
-- Insert questions and implemented_questions
...
INSERT INTO implemented_questions (fk_form, fk_question) VALUES (2, 92);

INSERT INTO questions (description_q, type_q) VALUES("Sí la organización en la que te desempeñas es propia", NULL);
INSERT INTO implemented_questions (fk_form, fk_question) VALUES (2, 93);
...
INSERT INTO implemented_questions (fk_form, fk_question) VALUES (2, 94);

INSERT INTO questions (description_q, type_q) VALUES("Sí tu respuesta es afirmativa especifica cuál", NULL);
INSERT INTO implemented_questions (fk_form, fk_question) VALUES (2, 95);
...
INSERT INTO implemented_questions (fk_form, fk_question) VALUES (2, 96);

INSERT INTO questions (description_q, type_q) VALUES("Cómo egresado(a) identificas los valores éticos de la empresa", NULL);
INSERT INTO implemented_questions (fk_form, fk_question) VALUES (2, 97);
...
INSERT INTO implemented_questions (fk_form, fk_question) VALUES (2, 98);
...
INSERT INTO implemented_questions (fk_form, fk_question) VALUES (2, 99);

INSERT INTO questions (description_q, type_q) VALUES("Te gustaría tomar algún curso de actualización", NULL);
INSERT INTO implemented_questions (fk_form, fk_question) VALUES (2, 100);

INSERT INTO questions (description_q, type_q) VALUES("Qué curso desearías tomar", NULL);
INSERT INTO implemented_questions (fk_form, fk_question) VALUES (2, 101);

INSERT INTO questions (description_q, type_q) VALUES("Perteneces a alguna Asociación Civil, Cámaras Industriales o Colegios Profesionales", NULL);
INSERT INTO implemented_questions (fk_form, fk_question) VALUES (2, 102);
...
INSERT INTO implemented_questions (fk_form, fk_question) VALUES (2, 103);

INSERT INTO questions (description_q, type_q) VALUES("Comentarios o sugerencias (Para mejorar la formación profesional de los egresados de tu carrera)", NULL);
INSERT INTO implemented_questions (fk_form, fk_question) VALUES (2, 104);
...
-- source ~/Documents/Cuarto-Semestre/sistemas-egresados-web/sql/inserts.sql
