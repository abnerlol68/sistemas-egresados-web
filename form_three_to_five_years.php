    ...
    <form action="Controller/form_three_to_five_years_ctrl.php" method="POST">
      <div class="content_form">
        ...
        <div class="qt" id="qt_1_10_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Grado Académico" id="qt_1_10_r_1" value="Licenciatura" checked>
        ...
        <div class="qt" id="qt_1_11_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Estado Civil" id="qt_1_11_r_1" value="Soltero" checked>
        ...
        <div class="qt" id="qt_1_13_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Titulado" id="qt_1_13_r_1" value="Si" checked>
        ...
        <div class="qt" id="qt_2_1_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Actualmente te encuentras laborando" id="qt_2_1_r_1" value="Si" checked>
        ...
        <div class="qt" id="qt_2_8_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Cuál es tu nivel jerárquico dentro de la empresa" id="qt_2_8_r_1" value="Operativo" checked>
        ...
        <div class="qt" id="qt_2_10_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Tamaño de la empresa" id="qt_2_10_r_1" value="Microempresa (1-30)" checked>
        ...
        <div class="qt" id="qt_2_11_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Sector económico al que pertenece tu empleo actual" id="qt_2_11_r_1" value="Primario (Agroindustria, pesquero, minero)" checked>
        ...
        <div class="qt" id="qt_2_12_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Régimen al que pertenece tu empleo actual" id="qt_2_12_r_1" value="Público" checked>
        ...
        <div class="qt" id="qt_3_1_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Cómo egresado(a) has participado en el desarrollo de aplicaciones computacionales creativas e innovadoras" id="qt_3_1_r_1" value="Si" checked>
        ...
        <div class="qt" id="qt_3_2_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Cómo egresado(a) cuando realizas el diseño de aplicaiones computacionales, has aplicado normas y estándares vigentes" id="qt_3_2_r_1" value="Si" checked>
        ...
        <div class="qt" id="qt_3_4_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Cómo egresado(a) has participado en el desarrollo de interfaces de atumatización" id="qt_3_4_r_1" value="Si" checked>
        ...
        <div class="qt" id="qt_3_5_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Cómo egresado(a) has desarrollado sistemas integrales descentralizados, como redes de computadoras, bases de datos distribuidas, sistemas ERP (Como SAO, COMPAQ), etc." id="qt_3_5_r_1" value="Si" checked>
        ...
        <div class="qt" id="qt_3_6_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Cómo egresado(a) has aplicado estándares internacionales en la integración de soluciones computacionales" id="qt_3_6_r_1" value="Si" checked>
        ...
        <div class="qt" id="qt_3_7_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Cómo egresado(a) has tomado cursos de actualización sobre tecnologías y estándares vigentes en el último año" id="qt_3_7_r_1" value="Si" checked>
        ...
        <div class="qt" id="qt_3_8_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Cómo egresado(a) has hecho uso de modelos y/o herramientas matemáticas para solucionar problemas complejos" id="qt_3_8_r_1" value="Sí, desarrollo de modelos y/o algoritmos" checked>
        ...
        <div class="qt" id="qt_3_9_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Cómo egresado(a) has desarrollado modelos y/o algoritmos para solucionar problemas de ingeniería" id="qt_3_9_r_1" value="Sí" checked>
        ...
        <div class="qt" id="qt_3_10_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Cómo egresado(a) has evaluado modelos y/o algoritmos para solucionar problemas de ingeniería" id="qt_3_10_r_1" value="Sí" checked>
        ...
        <div class="qt" id="qt_3_11_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Sí la organización en la que te desempeñas es propia" id="qt_3_11_r_1" value="El giro es adecuado a tu perfil de egreso" checked>
        ...
        <div class="qt" id="qt_3_12_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Sí la organización en la que ejerces no es propia, que función desempeñas" id="qt_3_12_r_1" value="Como líder de proyectos" checked>
        ...
        <div class="qt" id="qt_3_13_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Cómo egresado(a) has presentado artículos, carteles científicos, reportes técnicos o presentaciones electrónicas dentro de tus labores" id="qt_3_13_r_1" value="Si" checked>
        ...
        <div class="qt" id="qt_3_15_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Cómo egresado(a) has defendido ante audiencias tus propuestas de soluciones tecnológicas" id="qt_3_15_r_1" value="Si" checked>
        ...
        <div class="qt" id="qt_3_16_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Cómo egresado(a) identificas los valores éticos de la empresa" id="qt_3_16_r_1" value="Si" checked>
        ...
        <div class="qt" id="qt_3_17_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Cómo egresado(a) participas en el desarrollo de la planeación estratégica dentro los proyectos específicos" id="qt_3_17_r_1" value="Si" checked>
        ...
        <div class="qt" id="qt_3_18_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Cómo egresado(a) das seguimiento a la planeación estratégica del proyecto que desarrollas y/o implementas" id="qt_3_18_r_1" value="Si" checked>
        ...
        <div class="qt" id="qt_4_1_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Te gustaría tomar algún curso de actualización" id="qt_4_1_r_1" value="Si" checked>
        ...
        <div class="qt" id="qt_4_3_container">
          ...
          <div class="res">
            <div>
              <input class="input_radio" type="radio" name="Perteneces a alguna Asociación Civil, Cámaras Industriales o Colegios Profesionales" id="qt_4_3_r_1" value="Si" checked>
